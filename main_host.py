...
class Game:
    ...
    def new(self):
        ...
        self.Server_st()
        self.player1 = Player1(self, self.msg)
        self.player2 = Player2(self, self.msg)
    ...
    def binding(self,client_socket, addr):
    ...
    def Server_st(self):
        ...
        try:
            while True:
                ...
                th = threading.Thread(target=self.binding, args=(self.client_socket, addr))
                th.start()
